...
<section class="flex w-full max-w-md flex-col rounded-2xl border bg-white p-10 shadow-2xl">
	...
	<h2 class="mb-8 w-full text-center text-2xl font-bold">Verification Success</h2>
	...
	<div class="mb-5 flex flex-col items-center justify-center gap-5 text-center">
		<svg
			...
			viewBox="0 0 24 24"
			fill="currentColor"
			class="h-24 w-24 text-primary-200">
			<path
				fill-rule="evenodd"
